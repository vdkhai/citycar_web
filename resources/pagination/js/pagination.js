...
(function (factory) {
    ...
    Pagination.prototype = {
        ...
        render: function () {
            ...
            $target.empty();
            // 上一页
            $target.append('<li class="page-item"><a class="page-link" href="javascript:void(0)" data-page="prev">' + options.prev + '</a></li>');
            var page = this.getPages();
            if (page.start > 1) {
                $target.append('<li class="page-item"><a class="page-link" href="javascript:void(0)" data-page="' + 1 + '">' + 1 + '</a></li>');
                $target.append('<li class="page-item"><span>...</span></li>');

            }
            // 生成中间页码
            for (var i = page.start; i <= page.end; i++) {
                $target.append('<li class="page-item"><a class="page-link" href="javascript:void(0)" data-page="' + i + '">' + i + '</a></li>');
            }
            if (page.end < Math.ceil(options.total / options.length)) {
                $target.append('<li class="page-item"><span>...</span></li>');
                $target.append('<li class="page-item"><a class="page-link" href="javascript:void(0)" data-page="' + Math.ceil(options.total / options.length) + '">' + Math.ceil(options.total / options.length) + '</a></li>');
            }
            // 下一页
            $target.append('<li class="page-item"><a class="page-link" href="javascript:void(0)" data-page="next">' + options.next + '</a></li>');
            // 设置当前页样式class="page-link"
